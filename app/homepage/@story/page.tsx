    ...
    >
      ...
      >
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          ...
          Sydney, we found our true home. This move wasn't just about changing
          locations—it was about expanding our family to include the diverse,
          vibrant community of Parramatta, and we couldn't be happier with the
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          ...
          of Parramatta. We're not just serving food; we're sharing our family's
          legacy, one perfectly seasoned souvlaki at a time.
        </p>

        <p className="text-gray-700 leading-relaxed">
          When you dine with us, you're not just a customer—you become part of
          our extended family. We invite you to experience the warmth,
