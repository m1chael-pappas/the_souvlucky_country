// Blog post content. Lives outside the route file because Next.js only
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>Greece</td>
            <td>Greece</td>
            <td>Turkey/Middle East</td>
          </tr>
          <tr>
            <td><strong>Cooking Method</strong></td>
            <td>Skewered & grilled</td>
            <td>Vertical rotisserie</td>
            <td>Vertical rotisserie or grilled</td>
          </tr>
          <tr>
            <td><strong>Meat Type</strong></td>
            <td>Cubed pieces</td>
            <td>Stacked, shaved slices</td>
            <td>Minced or stacked</td>
          </tr>
          <tr>
            <td><strong>Typical Sauce</strong></td>
            <td>Tzatziki</td>
            <td>Tzatziki</td>
            <td>Garlic sauce, chilli</td>
          </tr>
          <tr>
            <td><strong>Bread</strong></td>
            <td>Pita bread</td>
            <td>Pita bread</td>
            <td>Turkish bread or pide</td>
          </tr>
        </tbody>
      </table>
